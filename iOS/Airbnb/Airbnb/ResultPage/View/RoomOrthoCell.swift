...
class RoomOrthoCell: UICollectionViewCell {

    static let reuseIdentifier = "RoomOrthoCell"
    static let nib = UINib(nibName: RoomOrthoCell.reuseIdentifier, bundle: nil)
